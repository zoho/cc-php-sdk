...
class Constants
{
    ...
    const CHOICE_NAMESPACE = "com\\zoho\\util\\Choice";
    ...
    const STREAM_WRAPPER_CLASS_PATH = "com\\zoho\\util\\StreamWrapper";
    ...
    const MANDATORY_NOT_FOUND = "Mandatory key Not Found";

    const PARAMETER_DUPLICATE_ERROR = "DUPLICATE PARAMETER ERROR";

    const EMPTY_CLASS_ERROR = "EMPTY CLASS NAME ERROR";

    const INVALID_CLASS_NAME = "INVALID CLASS NAME";

    const INVALID_DATA_TYPE = "INVALID DATATYPE";

    const INVALID_PARAM = "INVALID PARAM ERROR";
	
	const RESERVE_KEYWORD_USAGE_ERROR = "RESERVE KEYWORD USAGE ERROR";
	
	const PARAM_LENGTH_EXCEED_ERROR = "PARAM LENGTH EXCEED ERROR";

    const PARAM_LIMIT_EXCEED_ERROR = "PARAM LIMIT EXCEED ERROR";
    ...
    const FILE_NAMESPACE = "com\\zoho\\util\\StreamWrapper";
